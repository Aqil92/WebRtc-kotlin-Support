 ...
 * AppRTC demo.
 */
internal class AppRTCBluetoothManager private constructor(
    ...
    private inner class BluetoothHeadsetBroadcastReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (Objects.requireNonNull<String>(action) == BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED) {
    ...
    fun start() {
        ...
        Log.d(
            TAG,
            "HEADSET profile state: " + stateToString(bluetoothAdapter!!.getProfileConnectionState(BluetoothProfile.HEADSET))
        )
    ...
    companion object {
        private val TAG = "AppRTCBluetoothManager"
